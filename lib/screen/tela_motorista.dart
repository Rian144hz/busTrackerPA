                ...
                Row(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppColors.alertaAtraso.withOpacity(0.1),
                        borderRadius: BorderRadius.circular(10),
                      ),
                      child: Icon(Icons.warning_amber_rounded,
                          color: AppColors.alertaAtraso, size: 20),
                    ),
                  ...
                  children: _atrasosPreDefinidos.map((item) {
                    ...
                    return GestureDetector(
                      onTap: () async {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            ...
                            backgroundColor: AppColors.alertaAtraso,
                          ),
                        );
                      },
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          color: selecionado
                              ? AppColors.alertaAtraso
                              : AppColors.alertaAtraso.withOpacity(0.08),
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(
                            color: selecionado
                                ? AppColors.alertaAtraso
                                : AppColors.alertaAtraso.withOpacity(0.3),
                          ),
                        ),
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        // Placa — branco com texto azul escuro
                        Container(
                          padding: const EdgeInsets.symmetric(
                        ...
                        Marker(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              shape: BoxShape.circle,
                              border: Border.all(
                                  color: AppColors.branco, width: 2.5),
                              boxShadow: const [
                                BoxShadow(
        ...
        children: [
          FloatingActionButton.extended(
            ...
            backgroundColor: temAtraso
                ? AppColors.alertaAtraso
                : AppColors.alertaAtraso.withOpacity(0.12),
            foregroundColor: temAtraso
                ? AppColors.branco
                : AppColors.alertaAtraso,
          ...
          FloatingActionButton.extended(
            ...
            backgroundColor:
                _rastreando ? Colors.red[700] : AppColors.azulClaro,
