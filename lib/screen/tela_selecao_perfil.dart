      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: AppColors.gradientePrincipal,
          ),
        ),
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Image.asset(
                    'assets/images/logo_paulo_afonso.png',
                    width: 180,
                  ),
                ),
    ...
    showDialog(
      ...
      builder: (_) => StatefulBuilder(
        builder: (ctx, setDialogState) => AlertDialog(
          ...
          title: const Row(
            children: [
              Icon(Icons.drive_eta, color: AppColors.azulClaro),
              SizedBox(width: 8),
              Text('Motorista'),
            ],
          ),
    ...
    showDialog(
      ...
      builder: (_) => StatefulBuilder(
        builder: (ctx, setDialogState) => AlertDialog(
          ...
          title: const Row(
            children: [
              Icon(Icons.family_restroom_rounded, color: AppColors.azulMedio),
              SizedBox(width: 8),
                      ...
                      if (dados != null) {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) => TelaPai(
                              nomeResponsavel:
                                  dados['nomeResponsavel'] as String,
